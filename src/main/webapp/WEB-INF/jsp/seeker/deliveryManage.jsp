...
<script type="text/html" id="barDemo">
    ...
    <a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="enterprise">查看公司</a>
...
<script>
    ...
    layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider'], function(){
        ...
        table.render({
            elem: '#demo'
            ,height: 420
            ,url: '${pageContext.request.contextPath}/seeker/doDeliveryGet?seekerId='+${sessionScope.seeker.id}
            ,title: '投递表'
